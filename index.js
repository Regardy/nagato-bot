...
console.log(color(`[•]`, randomcolor), color(`Hallo : Im Furina`, randomcolor));
console.log(color(`[•]`, randomcolor), color(`Bot Version : 3.0.0`, randomcolor));
...
console.log(color(`[•]`, randomcolor), color(`Author : Rgbruh`, randomcolor));
console.log(color(`< =============================== >`, randomcolor));
...
function start(file) {
  if (isRunning) return;
  isRunning = true;
  console.log(chalk.blue('[INFO]'), 'Script ini sedang dipantau oleh Rgbruh');
