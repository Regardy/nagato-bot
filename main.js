...
async function connectionUpdate(update) {
    ...
    if (connection == 'connecting') {
        ...
        conn.sendMessage('6285794209006' + "@s.whatsapp.net", { text: `⚠️LAPOR BOS⚠️\n\nBOT ONLINE\n\n${date}`, mentions: ["6285794209006@s.whatsapp.net", jid] });
