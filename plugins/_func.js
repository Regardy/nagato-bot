...
handler.all = async function (m) {
    ...
    try {
        ...
        let res = await fetch('https://raw.githubusercontent.com/Regardy/y/refs/heads/main/nagato1.json')
        ...
        global.adReply = {
            contextInfo: {
                ...
                externalAdReply: { // Bagian ini sesuka kalian berkreasi :'v
                    ...
                    description: '',
                    previewType: "PHOTO",
                    thumbnail: await(await fetch(`https://images6.alphacoders.com/125/thumb-1920-1254283.jpg`)).buffer(),
                    sourceUrl: "",
                },
        ...
        global.ftextt = {
            ...
            message: {
                "extendedTextMessage": {
                    "text": me,
                    "title": me,
                    'jpegThumbnail': fs.readFileSync('./image/me.jpeg')
                }
            }
        }
        global.fliveLoc = {
            key: { fromMe: false, participant: "0@s.whatsapp.net", ...(m.chat ? { remoteJid: "status@broadcast" } : {}) },
            message: { "liveLocationMessage": { "caption": "Hi", "h": me, 'jpegThumbnail': fs.readFileSync('./image/me.jpeg') } }
        }
        global.fliveLoc2 = {
            key: { fromMe: false, participant: "0@s.whatsapp.net", ...(m.chat ? { remoteJid: "status@broadcast" } : {}) },
            message: { "liveLocationMessage": { "title": "Hi There Im Using GitHub", "h": me, 'jpegThumbnail': fs.readFileSync('./image/me.jpeg') } }
        }
        global.ftoko = {
            key: {
                fromMe: false,
            ...
            message: {
                "productMessage": {
                    "product": {
                        "productImage": {
                            "mimetype": "image/jpeg",
                            "jpegThumbnail": fs.readFileSync('./image/me.jpeg') //Gambarnye
                        },
